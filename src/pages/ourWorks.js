...
const Gif = styled.div`
    ...
    img{
        ...
        @media (max-width:500px){
            ...
            transform:translate(-620px,700px);
            height:200px;
            width:200px;
            object-fit:contain;
            z-index:5;
        ...
        >
            <div>
                <Link to="/"><img src="./mainlogo.svg" alt="top bar logo" /></Link> 
                    ...
                    <iframe data-aos="fade-up" width="100%" height="100%" src="https://www.youtube-nocookie.com/embed/Jd2GK0qDtRg?controls=0&amp;start=4&amp;loop=1&amp;autoplay=1&amp;mute=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
